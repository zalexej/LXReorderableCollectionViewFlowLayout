...
@property BOOL fixedScrollDirection;
...
- (BOOL)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout shouldBeginLongPressAtIndexPath:(NSIndexPath *)indexPath;
